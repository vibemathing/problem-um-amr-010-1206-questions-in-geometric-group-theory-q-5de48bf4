...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-010-1206-questions-in-geometric-group-theory-q-5de48bf4",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-010-1206-0920b6e31b02",
        "url": "https://www.unsolvedmath.com/problems/AMR-010-1206"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Assuming that the fixed subgroup Fix(α) is cyclic, find a bound on the length of a generator of Fix(α) in terms of the complexity of α.",
      "version": 1
    },
    "title": "Questions in Geometric Group Theory — Q 12.6",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "5d890c2a13a986286ddfb8b81975cb0912853d5df6b856154a582f166a79718c"
}
```
